...
## OUTPUT:
<img width="1637" height="183" alt="image" src="https://github.com/user-attachments/assets/eb0486b4-fbb6-4da1-b1b0-ebd94ec56cf1" />


## RESULT:
The host took 0.082992 seconds to complete its computation, while the GPU outperforms the host and completes the computation in 0.094596 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
